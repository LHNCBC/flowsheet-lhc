...
const JointLineScatterChart = React.createClass({
	render () {
  	return (
    	<ScatterChart width={600} height={400} margin={{top: 20, right: 20, bottom: 20, left: 20}}>
      	<CartesianGrid />
        <XAxis type="number" dataKey={'x'} name='stature' unit='cm' tick={false}/>
      	<YAxis type="number" dataKey={'y'} name='weight' unit='kg' />
      	<Scatter name='A school' data={data01} fill='#8884d8' line shape="circle"/>
      </ScatterChart>
    );
  }
})
