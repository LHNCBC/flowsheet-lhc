...
import loincTemp from "../stores/h17";
import cardiacTemp from "../stores/c17";
...
class TemplatePicker extends React.Component {
  ...
  constructor(props) {
    ...
    let list = [
        {name: 'Full View', file: 'h17.js', data: loincTemp},
        {name: 'Cardiac View', file: 'c17.js', data: cardiacTemp }
    ];
