...
import loincTemp from "../stores/h15";
import cardiacTemp from "../stores/c15";
...
class TemplatePicker extends React.Component {
  ...
  constructor(props) {
    ...
    let list = [
        {name: 'Full View', file: 'h15.js', data: loincTemp},
        {name: 'Cardiac View', file: 'c15.js', data: cardiacTemp }
    ];
